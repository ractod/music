...
const LoginModal = () => {
    ...
    const { loginModal } = useSelector(store => store.modalsState)
    ...
    return (
        <Modal onClose={closeHandler} open={loginModal.isOpen} className="flex items-center justify-center p-2" >
            <Box className="relative w-[400px] flex flex-col items-center py-4 px-3 rounded-xl text-white bg-background-light outline-none overflow-hidden">
                ...
                <form className="w-[95%] md:w-[80%] mt-5 z-10">    
                    ...
                    <Typography className="text-xs md:text-sm text-muted mt-4">
                        ...
                        <Typography component="span" className="font-medium cursor-pointer" onClick={openHandler}> Signup </Typography>
                    </Typography>
                    <Button variant="contained" color="primary" className="mt-8"> Login </Button>
                </form>
